...
public class DateTimePractice {
    ...
    //Print out the current the current local time in ISO_LOCAL_TIME
    ...
    //(Using the Period class) Take in int month, int day, int year for the date of birth, then print out the users 16th, 21st, 30th, and 100th birthdays
